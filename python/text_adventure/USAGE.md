...
### text_adventure.start_new_conversation
...
### text_adventure.end_conversation
...
- 核心实现：`text_adventure/agent.py`
- 技能管理：`text_adventure/skill.py`
- API 文档：`text_adventure/interfaces.py`, `LiteRT-LM/python/litert_lm/interfaces.py`
